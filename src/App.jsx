  ...
  return (
    <React.Fragment>
      ...
      <main>
        <div className="main-content-container">
          ...
          <div className="advanced-statistics-container">
            ...
            <div className="advanced-statistics-main">
              <div className="advanced-statistics-container-card">
                <div className="circle">
                  <SVGImages name="iconBrandRecognition" />
                </div>
              ...
              <div className="advanced-statistics-container-card">
                <div className="circle">
                  <SVGImages name="iconDetailedRecords" />
                </div>
              ...
              <div className="advanced-statistics-container-card">
                <div className="circle">
                  <SVGImages name="iconFullyCustomizable" />
                </div>
      ...
      <section className="boost-container">
        <div className="boost-content-container">
